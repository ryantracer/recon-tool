...
# script deve trazer informaçoes úteis sobre as tecnologias analisadas
...
if __name__ == '__main__':
    if args.internet_protocol:
        port_scanner(args.internet_protocol)
    elif args.recon:
        recon(args.recon)
    else:
        print('Usage: python portscanner.py -i <ip address> | -r <ip range> (optional: -w filename.txt for writing results in a .txt file)')
